...
namespace Sumantablog\Admin\Scheduling;
...
class Scheduling extends Extension
{
    ...
    protected static function registerRoutes()
    {
        parent::routes(function ($router) {
            ...
            $router->get('scheduling', 'Sumantablog\Admin\Scheduling\SchedulingController@index')->name('scheduling-index');
            $router->post('scheduling/run', 'Sumantablog\Admin\Scheduling\SchedulingController@runEvent')->name('scheduling-run');
        });
    }
